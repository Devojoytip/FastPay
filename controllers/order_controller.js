...
module.exports.show_home = async (req, res) => {
    var itemsOrdered = []
    var total = 0.0;
...
module.exports.deliver_fn = async (req, res) => {
...
module.exports.view_fn = async (req, res) => {
...
module.exports.alert_fn = async (req, res) => {
    const order = await Cart.findById(req.params.id).populate("shop").lean();
    const order2 = await Cart.findById(req.params.id).populate("user").lean();
